        ...
        <div className="max-w-3xl mx-auto space-y-10 text-text-muted leading-relaxed">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong className="text-text">Account data:</strong> name, email address,
                phone number, and password (stored as a salted hash).
              </li>
              <li>
                <strong className="text-text">Listing data:</strong> vehicle details,
                property information, photos, and pricing you submit.
              </li>
              <li>
                <strong className="text-text">Usage data:</strong> pages visited, search
                queries, and interaction events to improve the Platform.
              </li>
              <li>
                <strong className="text-text">Transaction data:</strong> payment records
          ...
          <div>
            <h2 className="text-xl font-bold text-text mb-3">5. Data Retention</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-text mb-3">6. Security</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-text mb-3">8. Your Rights</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold text-text mb-3">9. Changes to This Policy</h2>
            <p>
