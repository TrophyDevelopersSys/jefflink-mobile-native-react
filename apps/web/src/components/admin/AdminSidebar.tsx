...
const ROLE_MENUS: Record<string, string[]> = {
  SUPER_ADMIN:    ["dashboard","users","vendors","listings","cms","contracts","payments","installments","withdrawals","wallets","notifications","gps-tracking","reports","system-monitoring","audit-logs","settings"],
  ADMIN:          ["dashboard","users","vendors","listings","cms","contracts","payments","notifications","reports"],
  SYSTEM_ADMIN:   ["dashboard","users","vendors","listings","cms","contracts","payments","system-monitoring","reports","audit-logs"],
  DIRECTOR:       ["dashboard","users","vendors","contracts","payments","wallets","audit-logs"],
  MANAGER:        ["dashboard","users","vendors","listings","notifications","reports"],
  FINANCE_ADMIN:  ["dashboard","contracts","payments","installments","withdrawals","wallets"],
  FINANCE_OFFICER:["dashboard","contracts","payments","installments","wallets"],
  AUDITOR:        ["dashboard","contracts","payments","installments","audit-logs"],
  MODERATOR:      ["dashboard","listings","reports","notifications"],
  SUPPORT:        ["dashboard","users","notifications","reports"],
};
...
const NAV_ITEMS: { key: string; label: string; Icon: LucideIcon }[] = [
  ...
  { key: "gps-tracking",      label: "GPS Tracking",      Icon: MapPin },
  { key: "reports",           label: "Reports",           Icon: Flag },
  { key: "system-monitoring", label: "System Monitor",    Icon: Activity },
